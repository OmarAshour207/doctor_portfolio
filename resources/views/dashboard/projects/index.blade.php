                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.projects') }}</li>
                        </ol>
                    </nav>
                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($project->getTranslation('title', 'ar'), 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($project->getTranslation('title', 'en'), 20) }}
                                    </div>
                                </div>
                            </td>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($project->getTranslation('description', 'ar'), 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($project->getTranslation('description', 'en'), 20) }}
                                    </div>
                                </div>
                            </td>

                            <td style="width:120px" class="text-center">
                                <a href="{{ $project->project_image }}" data-lity>
