                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($service->getTranslation('title', 'ar'), 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($service->getTranslation('title', 'en'), 20) }}
                                    </div>
                                </div>
                            </td>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($service->getTranslation('description', 'ar'), 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ Str::limit($service->getTranslation('description', 'en'), 20) }}
                                    </div>
                                </div>
                            </td>

                            <td style="width:120px" class="text-center">
                                <a href="{{ $service->service_image }}" data-lity>
                                    <img src="{{ $service->thumb_image }}">
                                </a>
                            </td>
